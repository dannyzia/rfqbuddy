...
const EVENT_TYPE_META: Record<EventType, { label: string; color: string; dotColor: string; icon: React.ComponentType<{ className?: string }> }> = {
  deadline:     { label: "Submission Deadline", color: "text-red-600 dark:text-red-400",       dotColor: "bg-red-500",    icon: Clock },
...
const MOCK_EVENTS: CalendarEvent[] = [
  { id: "t-001", title: "PG-2026-001 — Office Supplies",       date: "2026-03-15T23:59:00Z", type: "deadline" },
  { id: "t-002", title: "PW-2026-015 — Road Rehabilitation",   date: "2026-03-18T10:00:00Z", type: "opening" },
  { id: "m-001", title: "Phase 2 Delivery — IT Equipment",     date: "2026-03-20T12:00:00Z", type: "milestone" },
  { id: "t-003", title: "PG-2026-003 — Medical Equipment",     date: "2026-03-22T23:59:00Z", type: "deadline" },
  { id: "c-001", title: "Security Services Contract Expires",  date: "2026-03-25T00:00:00Z", type: "contract_end" },
  { id: "t-004", title: "PPS-2026-008 — School Furniture",     date: "2026-03-28T23:59:00Z", type: "deadline" },
  { id: "t-005", title: "PG-2026-012 — Consulting Services",   date: "2026-04-02T10:00:00Z", type: "opening" },
  { id: "m-002", title: "Final Delivery — Civil Works Phase 3", date: "2026-04-05T12:00:00Z", type: "milestone" },
];
...
export function Calendar() {
  ...
  // Compute date range: 1st of previous month → last of next month (3-month window)
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 lg:p-8">
      <PageHeader
        ...
        description="Track tender deadlines, bid openings, milestones, and contract dates"
        actions={

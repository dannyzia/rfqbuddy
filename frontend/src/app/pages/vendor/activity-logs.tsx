...
export function VendorActivityLogs() {
  const activityLogs = [
    {
      id: 1,
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <PageHeader
        title="Activity Logs"
        description="Complete audit trail of all your vendor account activities"
        actions={
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => exportToCSV(activityLogs, "my_vendor_activity_logs")}>
              <Download className="size-4 mr-2" />
              Export CSV
            </Button>
            <Button variant="outline" onClick={() => exportToJSON(activityLogs, "my_vendor_activity_logs")}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="text-3xl font-bold mt-1 text-indigo-600">4</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-sm text-muted-foreground">Contracts Won</div>
            <div className="text-3xl font-bold mt-1 text-green-600">1</div>
          </CardContent>
        </Card>
      </div>

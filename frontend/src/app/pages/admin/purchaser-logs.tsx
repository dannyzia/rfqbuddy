...
export function AdminPurchaserLogs() {
  ...
  const activityLogs = [
    ...
    },
    {
      ...
      organization: "CleanCo Industries",
      user: "Mike Brown",
      action: "rfq.closed",
      entityType: "rfq",
    ...
    },
    {
      ...
      organization: "Finance Group Inc.",
      user: "Emma Davis",
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <PageHeader
        title="All Procuring Entity Activity Logs"
        description="Complete audit trail of all purchaser organizations' procurement activities"
        actions={
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => exportToCSV(activityLogs, "purchaser_activity_logs")}>
              <Download className="size-4 mr-2" />
              Export CSV
            </Button>
            <Button variant="outline" onClick={() => exportToJSON(activityLogs, "purchaser_activity_logs")}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="text-3xl font-bold mt-1 text-indigo-600">8</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-sm text-muted-foreground">Contracts Awarded</div>
            <div className="text-3xl font-bold mt-1 text-green-600">5</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-sm text-muted-foreground">Today</div>
            <div className="text-3xl font-bold mt-1 text-blue-600">12</div>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <Select defaultValue="all-orgs">
              ...
              <SelectContent>
                ...
                <SelectItem value="global">Global Health Systems</SelectItem>
                <SelectItem value="cleanco">CleanCo Industries</SelectItem>
                <SelectItem value="finance">Finance Group Inc.</SelectItem>
                <SelectItem value="build">BuildRight Construction</SelectItem>
              </SelectContent>
            </Select>
